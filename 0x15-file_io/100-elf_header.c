...
/**
 * check_elf - Is checking if a file is an ELF file.
 * @e_ident: A pointer to an array contains the ELF magic nums.
 *
...
/**
 * print_magic - Prints the magic numbs of the ELF header.
 * @e_ident: A pointer to an array contains the ELF magic numbs.
 *
 ...
 * Return: 0 on success.
 *
 * Description: If the file is not the ELF File or
